    ...
    return (
        <>
            <div className={styles.main}>
                ...
                <SubHeadingComp className={""}>{counter}</SubHeadingComp>
                <div className="buttonGroup">
                    <ButtonComp onClick={increasePlus} className={styles.}>+</ButtonComp>
                    <ButtonComp onClick={increaseMinus} className={styles.}>-</ButtonComp>
                    <ButtonComp onClick={increaseReset} className={styles.}>Reset</ButtonComp>
                </div>
            </div>
        </>
    );
